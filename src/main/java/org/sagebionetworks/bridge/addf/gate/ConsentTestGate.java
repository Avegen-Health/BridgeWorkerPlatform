 ...
 * {@code NO_SHARING} and they are not a {@code test_user}. Any failure to resolve the participant, a null scope, or an
 * unexpected error results in <em>skip</em> — never a default-open export.</p>
 *
...
public class ConsentTestGate {
    ...
    private ConsentVerdict evaluateScope(SharingScope scope, boolean isTest) {
        ...
        return ConsentVerdict.export(false);
    }
}
